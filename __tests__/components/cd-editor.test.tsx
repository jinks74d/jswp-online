 ...
 * embedded preview; toggling off is non-destructive (calls the action with
 * isQuotation:false, doesn't wipe stored fields); and the read-only path
 * (teacher review) hides the controls but keeps the preview.
 *
