    ...
    <div className="rounded-md border border-gray-200 bg-white p-3 space-y-2">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-32 rounded-md border border-gray-500 px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-green-700 disabled:opacity-50"
        />
        <button
          type="button"
          onClick={submit}
