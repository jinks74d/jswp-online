 ...
 * text. Pedagogyhint says 5; we don't enforce 5 — only ≥1. Tooltip
...
export function CmDevClient({
  ...
  const formColumn = (
    <div className="space-y-4 min-w-0">
      ...
      {activeBp ? (
        <CmDevBpPane writingId={writingId} bp={activeBp} />
      ) : (
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 pt-2 border-t border-gray-200">
        <div className="text-xs text-gray-500">
          {gate.canContinue
            ? "Each CD has at least one brainstormed word."
            : `Body paragraph ${gate.blockerPosition} needs at least one word per concrete detail.`}
        </div>
