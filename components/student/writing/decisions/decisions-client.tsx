 ...
 * gate any downstream step's data flow. Tooltip names the offending BP.
 */
...
export function DecisionsClient({
  ...
  const formColumn = (
    <div className="space-y-4 min-w-0">
      ...
      {activeBp ? (
        <DecisionsBpPane writingId={writingId} bp={activeBp} />
      ) : (
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 pt-2 border-t border-gray-200">
        <div className="text-xs text-gray-500">
          {gate.canContinue
            ? "Each body paragraph has at least one chunk-best word."
            : `Body paragraph ${gate.blockerPosition} needs at least one word marked 'best for chunk'.`}
        </div>
