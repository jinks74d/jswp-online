/**
 * Placeholder for district sidebar sections that don't have pages yet. Keeps
 * every nav target routable while the real feature is built.
 */
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-gray-300 bg-white px-6 py-16 text-center">
        ...
        <p className="max-w-sm text-sm text-gray-500">
          This section isn’t built yet. It’s on the roadmap for the district
          admin area.
        </p>
      </div>
    </div>
